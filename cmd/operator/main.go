...
import (
	...
	"github.com/vexil-platform/vexil/internal/operator/controllers"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "vexil-operator.vexil.io",
	})
	if err != nil {
	...
	setupLog.Info("starting Vexil operator")
